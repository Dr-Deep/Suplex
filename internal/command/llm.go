...
Speicherung z. B. in Redis, PostgreSQL oder einfach in Files/JSON.
Bot erkennt den User über Message.Author.ID und holt den zugehörigen Kontext.
So können mehrere Leute gleichzeitig mit dem gleichen LLM über denselben Bot reden, ohne dass die Kontexte sich vermischen.
